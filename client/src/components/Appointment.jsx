...
const Appointments = () => {
  ...
  useEffect(() => {
    axios.get("https://hms-backend-1-pngp.onrender.com/api/doctor/all")
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const doctorEmail = doctorDetails ? doctorDetails.Email : ""; // Get doctor's email
    ...
    try {
      ...
      if (response.status === 201 || response.status === 200) {
        ...
        // Fetch Zoom meeting details with doctor and user emails
        const zoomResponse = await axios.post("https://hms-backend-1-pngp.onrender.com/api/zoom/ZoomMeeting", { 
